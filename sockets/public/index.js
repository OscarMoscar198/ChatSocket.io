...
const EMPTY = 0;
const LITERAL = {
  sameUser: 'No te puedes chatear contigo mismo!, Consigue amigos!',
  minSizeUser: `El usuario debe tener <b>mínimo ${LENGTH_MIN_USERNAME}</b> caracteres`,
  uploadFile: 'Usted ha compartido un fichero',
  uploadSuccess: 'Fichero subido y compartiendo correctamente',
};
